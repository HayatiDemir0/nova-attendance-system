...
urlpatterns = [
    ...
    # Bu kısım ana yönetim sayfalarını kapsar
    ...
    path('ogrenciler/<int:pk>/', views.ogrenci_detay, name='ogrenci_detay'), # 'detay' kelimesine gerek kalmadan sadeleştirdik
    ...
    # Öğrenci Notu Düzenleme (Spesifik bir not ID'si üzerinden)
    path('ogrenciler/not/<int:pk>/duzenle/', views.ogrenci_not_duzenle, name='ogrenci_not_duzenle'),
    path('ogrenciler/not/<int:pk>/sil/', views.ogrenci_not_sil, name='ogrenci_not_sil'),
    ...
    path('yoklama/<int:pk>/', views.yoklama_detay, name='yoklama_detay'),
